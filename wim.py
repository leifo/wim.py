...
import wicked.meta.whdload.whdloadProxy
from wicked.meta.whdload.whdloadProxy import whdloadProxy # (could lead to an abstract interface beyond whdload)
...
#---get the arguments
print "Wim.py v0.41, WHDLoad Install Manager by Noname (21.09.2014)"
